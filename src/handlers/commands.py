...
async def cmd_start(message: Message):
    await message.answer(
        "👋 <b>Link Vault</b>\n\n"
        "Send any URL — I'll ask for a title and suggest a tag automatically.\n\n"
        "/list — browse your links by tag\n"
        "/find &lt;keyword&gt; — search by title or tag\n"
        "/review — full reading list grouped by topic\n"
        "/export — download links as a file\n"
        "/help — all commands",
        parse_mode="HTML"
    )
...
async def cmd_help(message: Message):
    await message.answer(
        ...
        "📥 <b>Save</b>\n"
        "Send any URL — I'll suggest a tag automatically.\n"
        "Then tap <i>Change tag</i> or <i>Edit title</i> if needed.\n\n"
        "📚 <b>Browse</b>\n"
        "/list — pick a tag to browse\n"
        "/list &lt;tag&gt; — jump straight to a tag\n"
        "/review — all links grouped by topic\n"
        "/archive — links you've finished\n\n"
        "🔍 <b>Search</b>\n"
        "/find &lt;keyword&gt; — search by title or tag\n\n"
        "🏷 <b>Tags</b>\n"
        "/tags — your full tag tree with counts\n"
        "/tag &lt;id&gt; &lt;tag&gt; — change a tag\n"
        "/retag &lt;id&gt; — AI re-suggest for one link\n"
        "/retag all — AI re-tag everything\n"
        "/duplicates — find and merge similar tags\n\n"
        "📌 <b>Status</b>\n"
        "/done &lt;id&gt; — mark as finished\n"
        "/pin &lt;id&gt; — pin to top\n"
        "/later &lt;id&gt; — snooze to end of list\n\n"
        "✏️ <b>Edit</b>\n"
        "/title &lt;id&gt; &lt;text&gt; — update a link's title\n"
        "/del &lt;id&gt; — delete a link\n\n"
        "📦 <b>Export / Import</b>\n"
        "/export — download links as a .json file\n"
        "Send a vault .json file → import into your list\n\n"
        "⏰ <b>Reading timer</b>\n"
        "/reading &lt;id&gt; — remind you in 20 min\n"
        "/reading &lt;id&gt; &lt;min&gt; — custom time",
        parse_mode="HTML"
    )
